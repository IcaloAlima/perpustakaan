 <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/dashboard" class="brand-link">
      <img src="/adminlte/dist/img/polibanew.PNG" alt="To Dashboard" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="/adminlte/dist/img/s4pwnew.jpeg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
